...
pathsNconsts = struct(  'simulationCommand',    'XVIIx64.exe -b -ascii', ...
                        'homePath',             'U:\ISIM3\PNP_2N3906', ...
                        'cirFileName',          'ISIM3cir_PNP_2N3906.cir', ...
                        'rawFileName',          'ISIM3cir_PNP_2N3906.raw', ...
...
f = plotVsatIcPNP(10,-1*[ [1:9]*1e-4 [1:9]*1e-3 [1:9]*1e-2 [1:4]*1e-1 ], pathsNconsts,simulationVariables);
d = plothfeIcPNP(5,[ [1:9].*1e-5 [1:9].*1e-4 [1:9].*1e-3],"return",pathsNconsts,simulationVariables);
